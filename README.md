...
Then open `notebooks/1_EDA.ipynb` and `notebooks/2_ML_Model.ipynb` 📓
...
python3 -m venv venv
source venv/bin/activate
# You should see (venv) in terminal before $
```
...
<table>
<tr>
<td><b>📊 Data Processing</b><br/>• pandas 2.3.3<br/>• numpy 2.2.6</td>
<td><b>📈 Visualization</b><br/>• matplotlib 3.10.8<br/>• seaborn 0.13.2<br/>• plotly 6.5.2</td>
</tr>
<tr>
<td><b>🤖 Machine Learning</b><br/>• scikit-learn 1.7.2<br/>• xgboost<br/>• lightgbm</td>
<td><b>📉 Statistical Analysis</b><br/>• scipy 1.15.3<br/>• statsmodels 0.14.6<br/>• ta-lib 0.11.0</td>
</tr>
<tr>
<td colspan="2"><b>💻 Development</b><br/>jupyter, ipython, ipywidgets, notebook</td>
</tr>
</table>
...
- ⚠️ Violates normality (important for advanced models)
...
|---|-------|------|------------|
| 1️⃣ | **Time Series** | Line | Complete 15-year price history with 3 market phases |
| 2️⃣ | **Correlation Heatmap** | Matrix | All features >0.97 correlated with Close |
| 3️⃣ | **Pairplot** | Scatter Matrix | Perfect linear relationships visible |
| 4️⃣ | **Rolling Averages** | Trend Line | 3-month & 12-month smoothed trends |
| 5️⃣ | **Price Spread** | Area Chart | Monthly High-Low volatility trends |
| 6️⃣ | **Monthly Returns** | Bar Chart | Clustered negative returns (2018-2020 crisis) |
| 7️⃣ | **Distributions** | Histogram | Right-skewed patterns (all columns) |
| 8️⃣ | **Boxplot Analysis** | Statistical | IQR-based outliers and spread |
| 9️⃣ | **Scatter vs Close** | Regression | Feature vs target linear fits |
| 🔟 | **Skewness Chart** | Bar | Quantified distribution asymmetry |
| 1️⃣1️⃣ | **Outlier Detection** | Box-IQR | 9 outliers detected (crisis period) |
...
| ⚖️ | **Model Comparison** | Bar Groups | R², RMSE, MAE, MAPE side-by-side |
...
| Aspect | Benefit |
|--------|---------|
| 🛡️ **Regularization** | L2 penalty prevents overfitting |
...
| ⚠️ **Risk Management** | Reduces extreme predictions |
...
**⚠️ Use this model for learning purposes only. Not financial advice. 💰**
